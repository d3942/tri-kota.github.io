...
<html lang="en-US">
<head>
<title>Привет я Полли</title>
<meta charset="utf-8">
<meta name="description" content="Я Полли">
<meta name="keywords" content="Я Полли">
<meta name="author" content="Я Полли">
<meta name="copyright" content="Я Полли">
				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx2-heading'>
							<p>
								 Привет я полли, и я обожаю фотографировать северное сияние и всё что с ним связано а так же всё что меня окружает.<br>
								 Xотя иногда хочеться сфотографировать летающую сардельку но пока не вышло.
							</p>
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							...
							<div class="github-tx2-mantra darkmode-txt">
								<p>
									 Я всегда готово для новых фотографий!
								</p>
							</div>
							...
							<div class="github-btn-button">
								...
								<div class="github-tx1-button">
									<span>Заглянуть в мой  проект</span>
								</div>
							</div>
							</a>
						</div>
					...
					<div class="patreon-con-mantra">
						<div class="patreon-wrp-mantra scale-content-txt-1 ">
							<div class="patreon-tx1-mantra darkmode-txt">
								<h2>Фотография это - моя жизнь</h2>
							</div>
							<div class="patreon-tx2-mantra darkmode-txt">
								<p>
									 Я каждый день стараюсь улучшить свои фотографии и предумываю новые идеи знакослюсь с новыми фотографами и часто зависаю в фотошопе. 
								</p>
							</div>
							<a href="###" target="_blank">
							<div class="patreon-btn-button">
								<div class="patreon-ico-">
								</div>
								<div class="patreon-tx1-button">
									<span>Глянуть в мои соцсети</span>
								</div>
							</div>
							</a>
						</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							<div class="discord-tx1-mantra darkmode-txt">
								<h2>Мой фото телеграм</h2>
							</div>
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 Помню эту группу там много людей а ещё кууууучу крутых фото жаль тебя там ещё нет(
								</p>
							</div>
							<a href="###" target="_blank">
							<div class="discord-btn-button">
								<div class="discord-ico-">
								</div>
								<div class="discord-tx1-button">
									<span>Открыть тайну телеграма</span>
								</div>
							</div>
							</a>
						</div>
